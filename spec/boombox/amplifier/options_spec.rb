          ...
          context 'and tte 0.5 years' do
            ...
            context 'and 25 steps' do
              ...
              it 'should compute European style call prices' do
                ...
                expect(engine2.with(strike: 80).solve_for(:value).price)
                  .to be_within(LR_PRECISION).of(23.75822)
                expect(engine2.with(strike: 90).solve_for(:value).price)
                  .to be_within(LR_PRECISION).of(16.09941)
                expect(engine2.with(strike: 100).solve_for(:value).price)
                  .to be_within(LR_PRECISION).of(10.13316)
                expect(engine2.with(strike: 110).solve_for(:value).price)
                  .to be_within(LR_PRECISION).of(5.94889)
                expect(engine2.with(strike: 120).solve_for(:value).price)
